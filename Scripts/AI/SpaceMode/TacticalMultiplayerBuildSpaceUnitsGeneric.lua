...
function Definitions()
	...
	TaskForce = {
		...
		,"CIS_Vulture_Droid_Squadron | CIS_Hyena_Bomber_Squadron | Gozanti_Cruiser | Dreadnaught_Heavy_Cruiser_CIS | Lucrehulk | Munificent_Frigate | Recusant_Frigate | CIS_HMP_Gunship_Squadron | CIS_Providence_IKM | Captor_Carrier | Wavecrest_Frigate | CIS_Supply_Ship = 0,3"
		,"Dreadnaught_Heavy_Cruiser_Rep | Rep_Y-Wing_Squadron | Carrack_Light_Cruiser | Rep_Acclamator | Arquitens_Light_Cruiser | Venator | Victory_SD | Valiant | Rothana_Battlecruiser | ARC170_Squadron | V-Wing_Squadron | Gladiator_Heavy_Cruiser | Maelstrom_Battlecruiser | Praetor_Battlecruiser | Secutor_Battlecarrier | Mandator_Dreadnaught |= 0,3"
